...
const (
	...
	sectionMapDescription    = "A map of custom sections in the item, keyed by section label. This allows easy lookup of sections and fields by name."
	...
	fileMapDescription           = "A map of files attached to the section, keyed by file ID."
